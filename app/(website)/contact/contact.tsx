  ...
  return (
    <Container>
      ...
      <div className="text-center">
        <p className="text-lg">We are looking forward to meeting you personally.</p>
      </div>
      ...
      <div className="grid my-10 md:grid-cols-2">
        <div className="my-10 lg:ml-auto lg:mr-24">
          ...
          <p className="max-w-md mt-5">
            Let us know how we can serve you better, and we hope to meet you this Sunday! If we missed something on this list, give us a call, or message us through this form
          </p>
          <div className="mt-5">
            {settings?.email && (
              <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-gray-400">
                <Mail className="flex-none w-5 h-5" />
            ...
            {settings?.phone && (
              ...
              <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-gray-400">
                <MessageCircle className="flex-none w-5 h-5" />
                <a href="https://m.me/bordergatebaptist" target="_blank">Messager</a>
              </div>
