    ...
    <div className="container mx-auto px-4">
      <article className="mb-10 prose max-w-full prose-ol:list-decimal prose-ol:ml-5 prose-ol:my-4 ">
        <ArticleHeading 
          ...
          description="Statement of faith, and what we believe"
          Icon={<DocumentDuplicateIcon className='h-full w-full' />}
        />
        
        <section className="text-xl/7  prose-h3:text-3xl prose-h3:py-5">
        <h3>SHORT STATEMENT OF THE CONFESSIONS OF FAITH</h3>
          <ol start={1}>
            <li>We believe the whole Bible from Genesis 1:1 to Revelation 22:21, as the verbally inspired and infallible Word of God.</li>
            <li>We believe Jesus Christ was born of Mary the Virgin, and is the Son of God, and God the Son.</li>
            <li>We believe that Christ died for our sins according to the Scriptures, the Just for the unjust that He might bring us to God.</li>
            <li>We believe that He arose from the grave the third day according to the scriptures.</li>
            <li>We believe that He, only, is the great High Priest, and we need not the intercession of any man, but that Christ ever liveth to make intercession for us.</li>
            <li>We believe that Christ will come again in Person bodily, visibly, to establish His Kingdom on the earth.</li>
            <li>We believe that in order to be saved, the soul must be born again — “Ye must be born again.”</li>
            <li>We believe that every truly born again soul should declare his faith by the act of baptism, (immersion in water) setting forth the Lord’s death, burial, and resurrection.</li>
            <li>We believe that the church is a body of baptized believers whose only mission is, not to “reform the world,” but to preach and teach the Word of God to the individual soul.</li>
          </ol>
